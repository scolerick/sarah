            ...
            <section id="main" class="wrapper style1">
            	<div class="inner">
                    ...
                    <section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-12-medium">
                                ...
                                <h3>Icons</h3>
                                <ul class="icons">
                                    <li><Link to="#" class="icon style1 fa-twitter"><span class="label">Twitter</span></Link></li>
                                    <li><Link to="#" class="icon style1 fa-facebook"><span class="label">Facebook</span></Link></li>
                                    <li><Link to="#" class="icon style1 fa-instagram"><span class="label">Instagram</span></Link></li>
                                    <li><Link to="#" class="icon style1 fa-github"><span class="label">Github</span></Link></li>
                                </ul>
                            </div>
                        </div>
                        <h2>Actions</h2>
                    ...
                    <section>
                        ...
                        <div class="box alt">
                            <div class="row gtr-uniform">
                                <div class="col-12"><span class="image fit"><img src="images/pic05.jpg" alt="" /></span></div>
